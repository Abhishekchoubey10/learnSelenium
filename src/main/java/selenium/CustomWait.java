...
public class CustomWait {
	...
	public static void main(String[] args) {
		...
		driver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(20));// page load timeout is saying that we can
																			// give me a max timeout in a duration. it
																			// means for time load of this we have given
																			// 20 sec, if after 20 sec if still page is
																			// not fully loaded, then it through that
																			// page is not loaded
