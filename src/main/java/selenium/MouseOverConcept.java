...
//		
		// donot confuse with select class in select class object we have to pass a
		// object, but in action class object, we have to pass driver
...
//		driver.findElement(By.linkText("COURSES")).click();
		...
		By childMenu = By.linkText("COURSES");// In Linktext write the visible text format on application, if we write a
												// html dom text in this it will not work and gives a
