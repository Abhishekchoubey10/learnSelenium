...
public class DifferentLocators {
	...
	public static void main(String[] args) {
		...
		// Types of locators like--id, xpath, name , className, css
		// 1. id: unique --I//Same id cannot be used for multiple element

		// 2. name: can be duplicate --II
		// driver.findElement(By.name("email")).sendKeys("test@gmail.com");
//		By emailId = By.name("email");// By locator strategy 
//		eleUtil.doSendKeys(emailId, "test@gmail.com");

//		String emailId_name = "email";// String locator strategy 
...
//		driver.findElement(By.cssSelector("#input-password")).sendKeys("test@123");
		...
		// html tag: <a>
		// whenever there is <a> tag, means that is link
//		By registerLink = By.linkText("Register");//In this link text we have to write the text format like 
		//Capital or small that is visible on webpage and not write according to html dom text
