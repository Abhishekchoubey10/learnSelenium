...
public class ExplicitWaitConcept {
	...
	public static WebElement waitForElementPresent(By locator, int timeOut) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOut));// Duration.ofSeconds is feature of
																					// selenium 4.x, before that we are
																					// using timeUnit.seconds
		return wait.until(ExpectedConditions.presenceOfElementLocated(locator));// in until method we have to pass true
																				// conditions
	}
